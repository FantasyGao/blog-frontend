<template>
    <div class="index">
        <div class="choose">
          ...
          <saveOption option="abstract">
            <Input style="width: 600px" v-model="subInfo.abstract" type="textarea" :rows="4" placeholder="请输入简介（20字到100字）"></Input>
          </saveOption>
        ...
        <div class="submit">
            <button @click='addArticle' class="btn btn-default form-control">保存</button>
        </div>
    </div>
</template>
